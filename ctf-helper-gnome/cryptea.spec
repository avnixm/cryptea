...
%check
desktop-file-validate %{buildroot}%{_datadir}/applications/org.example.CTFHelper.desktop

%files
%license LICENSE
%doc README.md INSTALL.md
%{_bindir}/ctf-helper
%{_datadir}/applications/org.example.CTFHelper.desktop
%{_datadir}/icons/hicolor/scalable/apps/org.example.CTFHelper.svg
%{_datadir}/doc/ctf-helper-gnome/README.md
